...
use DF\DigitalKassa\V2\DTO\Shared\AnotherAgentDTO;
use DF\DigitalKassa\V2\DTO\Shared\AttorneyDTO;
use DF\DigitalKassa\V2\DTO\Shared\BankPayingAgentDetailsDTO;
use DF\DigitalKassa\V2\DTO\Shared\BankPayingAgentDTO;
use DF\DigitalKassa\V2\DTO\Shared\BankPayingSubagentDTO;
use DF\DigitalKassa\V2\DTO\Shared\CashierDTO;
use DF\DigitalKassa\V2\DTO\Shared\CashlessPaymentsDTO;
use DF\DigitalKassa\V2\DTO\Shared\CommissionAgentDTO;
use DF\DigitalKassa\V2\DTO\Shared\CustomerDTO;
use DF\DigitalKassa\V2\DTO\Shared\MarkingDTO;
use DF\DigitalKassa\V2\DTO\Shared\MoneyTransferOperatorDTO;
use DF\DigitalKassa\V2\DTO\Shared\PayingAgentDetailsDTO;
use DF\DigitalKassa\V2\DTO\Shared\PayingAgentDTO;
use DF\DigitalKassa\V2\DTO\Shared\PayingSubagentDTO;
use DF\DigitalKassa\V2\DTO\Shared\PaymentOperatorDTO;
use DF\DigitalKassa\V2\DTO\Shared\ServiceDTO;
use DF\DigitalKassa\V2\DTO\Shared\SupplierDTO;
